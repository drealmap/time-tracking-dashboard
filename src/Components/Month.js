...
import { useDataAuth } from '../Contexts/DataContext';

const Month = () => {

    const { workdata, playdata,studydata,exercisedata, socialdata,selfcaredata } = useDataAuth() 

    return(
      <>
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#ff8c66] sm:mb-5'>
          <svg className='h-[90px] left-[60%] -mt-3 relative' width='79' height='79'>
            <path d="m18.687 10.43 15.464 30.906c.31.682.743 1.322 1.3 1.88.558.557 1.198.99 1.714 1.217L68.237 59.98 52.484 75.732a8.025 8.025 0 0 1-11.355 0L2.934 37.538a8.025 8.025 0 0 1 0-11.356L18.687 10.43Zm19.345-7.99 10.839 10.838 2.065-2.064a5.845 5.845 0 0 1 8.258 0l8.258 8.259a5.845 5.845 0 0 1 0 8.258l-2.064 2.064 10.839 10.84a8.025 8.025 0 0 1 0 11.355l-4.728 4.728L39.126 40.53a1.963 1.963 0 0 1-.578-.413 1.963 1.963 0 0 1-.413-.578L21.95 7.168l4.728-4.728a8.025 8.025 0 0 1 11.355 0Zm17.033 12.903-2.064 2.065 8.258 8.258 2.064-2.064-8.258-8.259Z" fill="#D96C47" fillRule="nonzero"/>
          </svg>
          <div style={{ contentVisibility: 'auto' }} className='rounded-2xl block bg-[#1c1f4a] justify-around -mt-[38px] hover:bg-[#6f76c8] hover:cursor-pointer sm:flex sm:justify-between sm:pb-3'>
            <div className='mt-[30px] ml-[30px] sm:ml-[35px]'>
              <h3 className='text-lg text-white'>{workdata.title}</h3>
              <h1 className='text-5xl mb-0 mt-[30px] font-semibold text-white sm:text-3xl'>{workdata.timeframes?.monthly.current}hrs</h1>
            </div>
            <div className='text-[#6f76c8] mt-[30px] sm:mr-2 sm:pr-[8px] sm:mt-[35px]'>
              ...
              <h5 className='ml-[30px] -mt-4 text-[#bdc1ff] text-sm sm:mt-16 sm:pb-0 sm:text-[0.8rem]'>Last Month - {workdata.timeframes?.monthly.previous}hrs</h5>
            </div>
          </div>
        </div>
        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#56c2e6] sm:mb-5'>
          <svg width="76" height="77" className='h-[90px] left-[60%] -mt-3 relative' >
          ...
          <div style={{ contentVisibility: 'auto' }} className='rounded-2xl block bg-[#1c1f4a] justify-around -mt-[38px] hover:bg-[#6f76c8] hover:cursor-pointer sm:flex sm:justify-between sm:pb-3'>
            ...
            <div className='mt-[30px] ml-[30px] sm:ml-[35px]'>
              <h3 className='text-lg text-white'>{playdata.title}</h3>
              <h1 className='text-5xl mb-0 mt-[30px] font-semibold text-white sm:text-3xl'>{playdata.timeframes?.monthly.current}hrs</h1>
            </div>
            ...
            <div className='text-[#6f76c8] mt-[30px] sm:mr-2 sm:pr-[8px] sm:mt-[35px]'>
              ...
              <h5 className='ml-[30px] -mt-4 text-[#bdc1ff] text-sm sm:mt-16 sm:pb-0 sm:text-[0.8rem]'>Last Month - {playdata.timeframes?.monthly.previous}hrs</h5>
            </div>
          </div>
        </div>
        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#ff5c7c] sm:mb-5'>
          ...
          <div style={{ contentVisibility: 'auto' }} className='rounded-2xl block bg-[#1c1f4a] justify-around -mt-[38px] hover:bg-[#6f76c8] hover:cursor-pointer sm:flex sm:justify-between sm:pb-3'>
            ...
            <div className='text-[#6f76c8] mt-[30px] sm:mr-2 sm:pr-[8px] sm:mt-[35px]'>
              ...
              <h5 className='ml-[30px] -mt-4 text-[#bdc1ff] text-sm sm:mt-16 sm:pb-0 sm:text-[0.8rem]'>Last Month - {studydata.timeframes?.monthly.previous}hrs</h5>
            </div>
        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#4acf81] sm:mb-5'>
          ...
          <div style={{ contentVisibility: 'auto' }} className='rounded-2xl block bg-[#1c1f4a] justify-around -mt-[38px] hover:bg-[#6f76c8] hover:cursor-pointer sm:flex sm:justify-between sm:pb-3'>
            ...
            <div className='text-[#6f76c8] mt-[30px] sm:mr-2 sm:pr-[8px] sm:mt-[35px]'>
              ...
              <h5 className='ml-[30px] -mt-4 text-[#bdc1ff] text-sm sm:mt-16 sm:pb-0 sm:text-[0.8rem]'>Last Month - {exercisedata.timeframes?.monthly.previous}hrs</h5>
            </div>
        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#7536d3] sm:mb-5'>
          <svg width="75" height="85" className='h-[90px] left-[60%] -mt-3 relative'>
          ...
          <div style={{ contentVisibility: 'auto' }} className='rounded-2xl block bg-[#1c1f4a] justify-around -mt-[38px] hover:bg-[#6f76c8] hover:cursor-pointer sm:flex sm:justify-between sm:pb-3'>
            <div className='mt-[30px] ml-[30px] sm:ml-[35px]'>
              <h3 className='text-lg text-white'>{socialdata.title}</h3>
              <h1 className='text-5xl mb-0 mt-[30px] font-semibold text-white sm:text-3xl'>{socialdata.timeframes?.monthly.current}hrs</h1>
            </div>
              <div className='text-[#6f76c8] mt-[30px] sm:mr-2 sm:pr-[8px] sm:mt-[35px]'>
              <svg className='float-right -mt-[110px] mr-[30px] sm:mt-2 sm:mr-0' width='21' height='5'>
                <path d="M2.5 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z" fill="#BBC0FF" fillRule="evenodd"/>
              </svg>
              <h5 className='ml-[30px] -mt-4 text-[#bdc1ff] text-sm sm:mt-16 sm:pb-0 sm:text-[0.8rem]'>Last Month - {socialdata.timeframes?.monthly.previous}hrs</h5>
            </div>
        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#f1c65b] sm:mb-5'>
          <svg width="67" height="83" className='h-[90px] left-[60%] -mt-3 relative'>
            <path d="M.918 50.848c.114 1.723.232 3.5.346 5.336l.003.038.448 6.038c.06.81.412 1.536.951 2.075.54.54 1.266.892 2.075.952l6.038.447.038.003c12.086.755 21.237 1.231 28.95.484 9.007-.873 15.369-3.445 20.02-8.096 8.413-8.413 8.398-21.609-.034-30.041-3.79-3.79-8.959-6.11-14.31-6.526-.415-5.352-2.736-10.52-6.526-14.31C30.484-1.185 17.288-1.2 8.875 7.214-1.295 17.384-.415 30.697.918 50.848ZM21.36 27.122l6.172 6.173 6.16-6.159 6.172 6.173-6.16 6.158 6.173 6.173-6.158 6.158-6.173-6.172-6.158 6.158-6.173-6.172 6.159-6.159-6.173-6.172 6.16-6.159Z" fill="#E6A532" fillRule="nonzero"/>
          </svg>
          <div style={{ contentVisibility: 'auto' }} className='rounded-2xl block bg-[#1c1f4a] justify-around -mt-[38px] hover:bg-[#6f76c8] hover:cursor-pointer sm:flex sm:justify-between sm:pb-3'>
            <div className='mt-[30px] ml-[30px] sm:ml-[35px]'>
              <h3 className='text-lg text-white'>{selfcaredata.title}</h3>
              <h1 className='text-5xl mb-0 mt-[30px] font-semibold text-white sm:text-3xl'>{selfcaredata.timeframes?.monthly.current}hrs</h1>
            </div>
            <div className='text-[#6f76c8] mt-[30px] sm:mr-2 sm:pr-[8px] sm:mt-[35px]'>
              <svg width='21' height='5' className='float-right -mt-[110px] mr-[30px] sm:mt-2 sm:mr-0'>
                <path d="M2.5 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z" fill="#BBC0FF" fillRule="evenodd"/>
              ...
              <h5 className='ml-[30px] -mt-4 text-[#bdc1ff] text-sm sm:mt-16 sm:pb-0 sm:text-[0.8rem]'>Last Month - {selfcaredata.timeframes?.monthly.previous}hrs</h5>
            </div>
