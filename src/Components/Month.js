...
const Month = () => {
    ...
    return(
      <>
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#ff8c66]'>
          ...
          <div style={{ contentVisibility: 'auto' }} className='rounded-2xl block bg-[#1c1f4a] justify-around -mt-[38px] hover:bg-[#6f76c8] hover:cursor-pointer'>
            <div className='mt-[30px] ml-[30px]'>
              ...
              <h1 className='text-5xl mb-0 mt-[30px] font-semibold text-white'>{workdata.timeframes?.monthly.current}hrs</h1>
            </div>
            <div className='text-[#6f76c8] mt-[30px]'>
              ...
              <h5 className='ml-[30px] -mt-4 text-[#bdc1ff] text-sm'>Last Month - {workdata.timeframes?.monthly.previous}hrs</h5>
            </div>
          </div>
        </div>
        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#56c2e6]'>
          ...
          <div style={{ contentVisibility: 'auto' }} className='rounded-2xl block bg-[#1c1f4a] justify-around -mt-[38px] hover:bg-[#6f76c8] hover:cursor-pointer'>
            ...
            <div className='mt-[30px] ml-[30px]'>
              ...
              <h1 className='text-5xl mb-0 mt-[30px] font-semibold text-white'>{playdata.timeframes?.monthly.current}hrs</h1>
            </div>
            ...
            <div className='text-[#6f76c8] mt-[30px]'>
              ...
              <h5 className='ml-[30px] -mt-4 text-[#bdc1ff] text-sm'>Last Month - {playdata.timeframes?.monthly.previous}hrs</h5>
            </div>
          </div>
        </div>
        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#ff5c7c]'>
          ...
          <div style={{ contentVisibility: 'auto' }} className='rounded-2xl block bg-[#1c1f4a] justify-around -mt-[38px] hover:bg-[#6f76c8] hover:cursor-pointer'>
            <div className='mt-[30px] ml-[30px]'>
              ...
              <h1 className='text-5xl mb-0 mt-[30px] font-semibold text-white'>{studydata.timeframes?.monthly.current}hrs</h1>
            </div>
            ...
            <div className='text-[#6f76c8] mt-[30px]'>
              ...
              <h5 className='ml-[30px] -mt-4 text-[#bdc1ff] text-sm'>Last Month - {studydata.timeframes?.monthly.previous}hrs</h5>
            </div>
        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#4acf81]'>
          ...
          <div style={{ contentVisibility: 'auto' }} className='rounded-2xl block bg-[#1c1f4a] justify-around -mt-[38px] hover:bg-[#6f76c8] hover:cursor-pointer'>
            <div className='mt-[30px] ml-[30px]'>
              ...
              <h1 className='text-5xl mb-0 mt-[30px] font-semibold text-white'>{exercisedata.timeframes?.monthly.current}hrs</h1>
            </div>
            ...
            <div className='text-[#6f76c8] mt-[30px]'>
              ...
              <h5 className='ml-[30px] -mt-4 text-[#bdc1ff] text-sm'>Last Month - {exercisedata.timeframes?.monthly.previous}hrs</h5>
            </div>
        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#7536d3]'>
          ...
          <div style={{ contentVisibility: 'auto' }} className='rounded-2xl block bg-[#1c1f4a] justify-around -mt-[38px] hover:bg-[#6f76c8] hover:cursor-pointer'>
            <div className='mt-[30px] ml-[30px]'>
              ...
              <h1 className='text-5xl mb-0 mt-[30px] font-semibold text-white'>{socialdata.timeframes?.monthly.current}hrs</h1>
            </div>
              <div className='text-[#6f76c8] mt-[30px]'>
              <svg className='float-right -mt-[110px] mr-[30px]' width='21' height='5'>
                <path d="M2.5 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z" fill="#BBC0FF" fillRule="evenodd"/>
              </svg>
              <h5 className='ml-[30px] -mt-4 text-[#bdc1ff] text-sm'>Last Month - {socialdata.timeframes?.monthly.previous}hrs</h5>
            </div>
        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#f1c65b]'>
          ...
          <div style={{ contentVisibility: 'auto' }} className='rounded-2xl block bg-[#1c1f4a] justify-around -mt-[38px] hover:bg-[#6f76c8] hover:cursor-pointer'>
            <div className='mt-[30px] ml-[30px]'>
              ...
              <h1 className='text-5xl mb-0 mt-[30px] font-semibold text-white'>{selfcaredata.timeframes?.monthly.current}hrs</h1>
            </div>
            <div className='text-[#6f76c8] mt-[30px]'>
              <svg width='21' height='5' className='float-right -mt-[110px] mr-[30px]'>
                <path d="M2.5 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z" fill="#BBC0FF" fillRule="evenodd"/>
              ...
              <h5 className='ml-[30px] -mt-4 text-[#bdc1ff] text-sm'>Last Month - {selfcaredata.timeframes?.monthly.previous}hrs</h5>
            </div>
