    ...
    return(
      <>
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#ff8c66] sm:mb-5'>
          ...
          <Infobox title={workdata.title} current={workdata.timeframes?.weekly.current} previous={workdata.timeframes?.weekly.previous} />
        </div>
        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#56c2e6] sm:mb-5'>
          ...
          <Infobox title={playdata.title} current={playdata.timeframes?.weekly.current} previous={playdata.timeframes?.weekly.previous} />
        </div>
        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#ff5c7c] sm:mb-5'>
          ...
          <Infobox title={studydata.title} current={studydata.timeframes?.weekly.current} previous={studydata.timeframes?.weekly.previous} />
        </div>
        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#4acf81] sm:mb-5'>
          ...
          <Infobox title={exercisedata.title} current={exercisedata.timeframes?.weekly.current} previous={exercisedata.timeframes?.weekly.previous} />
        </div>
        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#7536d3] sm:mb-5'>
          ...
          <Infobox title={socialdata.title} current={socialdata.timeframes?.weekly.current} previous={socialdata.timeframes?.weekly.previous} />
        </div>
        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#f1c65b] sm:mb-5'>
          ...
          <Infobox title={selfcaredata.title} current={selfcaredata.timeframes?.weekly.current} previous={selfcaredata.timeframes?.weekly.previous} />
        </div>
      </>
    )
  }
