        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#ff8c66] sm:mb-5'>
          ...
          <div style={{ contentVisibility: 'auto' }} className='rounded-2xl block bg-[#1c1f4a] justify-around -mt-[38px] hover:bg-[#6f76c8] hover:cursor-pointer sm:flex sm:justify-between sm:pb-3' >
            <div className='mt-[30px] ml-[30px] sm:ml-[35px]'>
              ...
              <h1 className='text-5xl mb-0 mt-[30px] font-semibold text-white sm:text-3xl'>{workdata.timeframes?.daily.current}hrs</h1>
            </div>
            <div className='text-[#6f76c8] mt-[30px] sm:mr-2 sm:pr-[8px] sm:mt-[35px]'>
              ...
              <h5 className='ml-[30px] -mt-4 text-[#bdc1ff] text-sm sm:mt-16 sm:pb-0 sm:text-[0.8rem]'>Yesterday - {workdata.timeframes?.daily.previous}hrs</h5>
            </div>
          </div>
        </div>
        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#56c2e6] sm:mb-5'>
          ...
          <div style={{ contentVisibility: 'auto' }} className='rounded-2xl block bg-[#1c1f4a] justify-around -mt-[38px] hover:bg-[#6f76c8] hover:cursor-pointer sm:flex sm:justify-between sm:pb-3'>
            ...
            <div className='mt-[30px] ml-[30px] sm:ml-[35px]'>
              ...
              <h1 className='text-5xl mb-0 mt-[30px] font-semibold text-white sm:text-3xl'>{playdata.timeframes?.daily.current}hrs</h1>
            </div>
            ...
            <div className='text-[#6f76c8] mt-[30px] sm:mr-2 sm:pr-[8px] sm:mt-[35px]'>
              ...
              <h5 className='ml-[30px] -mt-4 text-[#bdc1ff] text-sm sm:mt-16 sm:pb-0 sm:text-[0.8rem]'>Yesterday - {playdata.timeframes?.daily.previous}hrs</h5>
            </div>
          </div>
        </div>
        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#ff5c7c] sm:mb-5'>
          ...
          <div style={{ contentVisibility: 'auto' }} className='rounded-2xl block bg-[#1c1f4a] justify-around -mt-[38px] hover:bg-[#6f76c8] hover:cursor-pointer sm:flex sm:justify-between sm:pb-3'>
            <div className='mt-[30px] ml-[30px] sm:ml-[35px]'>
              ...
              <h1 className='text-5xl mb-0 mt-[30px] font-semibold text-white sm:text-3xl'>{studydata.timeframes?.daily.current}hrs</h1>
            </div>
            ...
            <div className='text-[#6f76c8] mt-[30px] sm:mr-2 sm:pr-[8px] sm:mt-[35px]'>
              ...
              <h5 className='ml-[30px] -mt-4 text-[#bdc1ff] text-sm sm:mt-16 sm:pb-0 sm:text-[0.8rem]'>Yesterday - {studydata.timeframes?.daily.previous}hrs</h5>
            </div>
        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#4acf81] sm:mb-5'>
          ...
          <div style={{ contentVisibility: 'auto' }} className='rounded-2xl block bg-[#1c1f4a] justify-around -mt-[38px] hover:bg-[#6f76c8] hover:cursor-pointer sm:flex sm:justify-between sm:pb-3'>
            <div className='mt-[30px] ml-[30px] sm:ml-[35px]'>
              ...
              <h1 className='text-5xl mb-0 mt-[30px] font-semibold text-white sm:text-3xl'>{exercisedata.timeframes?.daily.current}hrs</h1>
            </div>
            ...
            <div className='text-[#6f76c8] mt-[30px] sm:mr-2 sm:pr-[8px] sm:mt-[35px]'>
              ...
              <h5 className='ml-[30px] -mt-4 text-[#bdc1ff] text-sm sm:mt-16 sm:pb-0 sm:text-[0.8rem]'>Yesterday - {exercisedata.timeframes?.daily.previous}hrs</h5>
            </div>
        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#7536d3] sm:mb-5'>
          ...
          <div style={{ contentVisibility: 'auto' }} className='rounded-2xl block bg-[#1c1f4a] justify-around -mt-[38px] hover:bg-[#6f76c8] hover:cursor-pointer sm:flex sm:justify-between sm:pb-3'>
            <div className='mt-[30px] ml-[30px] sm:ml-[35px]'>
              ...
              <h1 className='text-5xl mb-0 mt-[30px] font-semibold text-white sm:text-3xl'>{socialdata.timeframes?.daily.current}hrs</h1>
            </div>
              <div className='text-[#6f76c8] mt-[30px] sm:mr-2 sm:pr-[8px] sm:mt-[35px]'>
              <svg className='float-right -mt-[110px] mr-[30px] sm:mt-2 sm:mr-0' width='21' height='5'>
                <path d="M2.5 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z" fill="#BBC0FF" fillRule="evenodd"/>
              </svg>
              <h5 className='ml-[30px] -mt-4 text-[#bdc1ff] text-sm sm:mt-16 sm:pb-0 sm:text-[0.8rem]'>Yesterday - {socialdata.timeframes?.daily.previous}hrs</h5>
            </div>
        ...
        <div style={{ contentVisibility: 'auto' }} className='rounded-2xl m-0 bg-[#f1c65b] sm:mb-5'>
          ...
          <div style={{ contentVisibility: 'auto' }} className='rounded-2xl block bg-[#1c1f4a] justify-around -mt-[38px] hover:bg-[#6f76c8] hover:cursor-pointer sm:flex sm:justify-between sm:pb-3'>
            <div className='mt-[30px] ml-[30px] sm:ml-[35px]'>
              ...
              <h1 className='text-5xl mb-0 mt-[30px] font-semibold text-white sm:text-3xl'>{selfcaredata.timeframes?.daily.current}hrs</h1>
            </div>
            <div className='text-[#6f76c8] mt-[30px] sm:mr-2 sm:pr-[8px] sm:mt-[35px]'>
              <svg width='21' height='5' className='float-right -mt-[110px] mr-[30px] sm:mt-2 sm:mr-0'>
                <path d="M2.5 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z" fill="#BBC0FF" fillRule="evenodd"/>
              ...
              <h5 className='ml-[30px] -mt-4 text-[#bdc1ff] text-sm sm:mt-16 sm:pb-0 sm:text-[0.8rem]'>Yesterday - {selfcaredata.timeframes?.daily.previous}hrs</h5>
            </div>
