...
const Card = () => {
  ...
  const Week = () => {
    return(
      <>
        <div className='work'>
          <svg className='work_icon' width='79' height='79'>
          ...
          <div className='info_box'>
            <div className='left_side'>
              ...
              <h1>{workdata.timeframes?.weekly.current}hrs</h1>
            </div>
            <div className='right_side'>
              ...
              <h5>Last Week - {workdata.timeframes?.weekly.previous}hrs</h5>
            </div>
          </div>
        </div>
        ...
        <div className='play'>
          <svg width="76" height="77" className='play_icon' >
          ...
          <div className='info_box'>
            ...
            <div className='left_side'>
              ...
              <h1>{playdata.timeframes?.weekly.current}hrs</h1>
            </div>
            ...
            <div className='right_side'>
              ...
              <h5>Last Week - {playdata.timeframes?.weekly.previous}hrs</h5>
            </div>
          </div>
        </div>
        ...
        <div className='study'>
          <svg width="79" height="79" className='study_icon' >
          ...
          <div className='info_box'>
            <div className='left_side'>
              ...
              <h1>{studydata.timeframes?.weekly.current}hrs</h1>
            </div>
            ...
            <div className='right_side'>
              ...
              <h5>Last Week - {studydata.timeframes?.weekly.previous}hrs</h5>
            </div>
        ...
        <div className='exercise'>
          <svg width="81" height="73" className='exercise_icon'>
          ...
          <div className='info_box'>
            <div className='left_side'>
              ...
              <h1>{exercisedata.timeframes?.weekly.current}hrs</h1>
            </div>
            ...
            <div className='right_side'>
              ...
              <h5>Last Week - {exercisedata.timeframes?.weekly.previous}hrs</h5>
            </div>
        ...
        <div className='social'>
          <svg width="75" height="85" className='social_icon'>
          ...
          <div className='info_box'>
            <div className='left_side'>
              ...
              <h1>{socialdata.timeframes?.weekly.current}hrs</h1>
            </div>
              <div className='right_side'>
              <svg className='ellipses' width='21' height='5'>
                <path d="M2.5 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z" fill="#BBC0FF" fillRule="evenodd"/>
              </svg>
              <h5>Last Week - {socialdata.timeframes?.weekly.previous}hrs</h5>
            </div>
        ...
        <div className='self_care'>
          <svg width="67" height="83" className='self_care_icon'>
          ...
          <div className='info_box'>
            <div className='left_side'>
              <h3>{selfcaredata.title}</h3>
              <h1>{selfcaredata.timeframes?.weekly.current}hrs</h1>
            </div>
            <div className='right_side'>
              <svg width='21' height='5' className='ellipses'>
                <path d="M2.5 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z" fill="#BBC0FF" fillRule="evenodd"/>
              ...
              <h5>Last Week - {selfcaredata.timeframes?.weekly.previous}hrs</h5>
            </div>
      ...
      <>
        <div className='work'>
          ...
          <div className='info_box'>
            <div className='left_side'>
              <h3>{workdata.title}</h3>
              <h1>{workdata.timeframes?.daily.current}hrs</h1>
            </div>
            <div className='right_side'>
              <svg width= '21' height='5' className='ellipses' >
                <path d="M2.5 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z" fill="#BBC0FF" fillRule="evenodd"/>
              ...
              <h5>Yesterday - {workdata.timeframes?.daily.previous}hrs</h5>
            </div>
          </div>
        </div>
        ...
        <div className='play'>
          ...
          <div className='info_box'>
            ...
            <div className='left_side'>
              <h3>{playdata.title}</h3>
              <h1>{playdata.timeframes?.daily.current}hrs</h1>
            </div>
            ...
            <div className='right_side'>
              ...
              <h5>Yesterday - {playdata.timeframes?.daily.previous}hrs</h5>
            </div>
          </div>
        </div>
        ...
        <div className='study'>
          ...
          <div className='info_box'>
            <div className='left_side'>
              <h3>{studydata.title}</h3>
              <h1>{studydata.timeframes?.daily.current}hrs</h1>
            </div>
            ...
            <div className='right_side'>
              ...
              <h5>Yesterday - {studydata.timeframes?.daily.previous}hrs</h5>
            </div>
        ...
        <div className='exercise'>
          ...
          <div className='info_box'>
            <div className='left_side'>
              <h3>{exercisedata.title}</h3>
              <h1>{exercisedata.timeframes?.daily.current}hrs</h1>
            </div>
            ...
            <div className='right_side'>
              ...
              <h5>Yesterday - {exercisedata.timeframes?.daily.previous}hrs</h5>
            </div>
        ...
        <div className='social'>
          ...
          <div className='info_box'>
            <div className='left_side'>
              <h3>{socialdata.title}</h3>
              <h1>{socialdata.timeframes?.daily.current}hrs</h1>
            </div>
              <div className='right_side'>
              <svg className='ellipses' width='21' height='5'>
                <path d="M2.5 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z" fill="#BBC0FF" fillRule="evenodd"/>
              </svg>
              <h5>Yesterday - {socialdata.timeframes?.daily.previous}hrs</h5>
            </div>
        ...
        <div className='self_care'>
          ...
          <div className='info_box'>
            <div className='left_side'>
              <h3>{selfcaredata.title}</h3>
              <h1>{selfcaredata.timeframes?.daily.current}hrs</h1>
            </div>
            <div className='right_side'>
              <svg width='21' height='5' className='ellipses'>
                <path d="M2.5 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z" fill="#BBC0FF" fillRule="evenodd"/>
              ...
              <h5>Yesterday - {selfcaredata.timeframes?.daily.previous}hrs</h5>
            </div>
      ...
      <>
        <div className='work'>
          ...
          <div className='info_box'>
            <div className='left_side'>
              <h3>{workdata.title}</h3>
              <h1>{workdata.timeframes?.monthly.current}hrs</h1>
            </div>
            <div className='right_side'>
              <svg width= '21' height='5' className='ellipses' >
                <path d="M2.5 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z" fill="#BBC0FF" fillRule="evenodd"/>
              ...
              <h5>Last Month - {workdata.timeframes?.monthly.previous}hrs</h5>
            </div>
          </div>
        </div>
        ...
        <div className='play'>
          ...
          <div className='info_box'>
            ...
            <div className='left_side'>
              <h3>{playdata.title}</h3>
              <h1>{playdata.timeframes?.monthly.current}hrs</h1>
            </div>
            ...
            <div className='right_side'>
              ...
              <h5>Last Month - {playdata.timeframes?.monthly.previous}hrs</h5>
            </div>
          </div>
        </div>
        ...
        <div className='study'>
          ...
          <div className='info_box'>
            <div className='left_side'>
              <h3>{studydata.title}</h3>
              <h1>{studydata.timeframes?.monthly.current}hrs</h1>
            </div>
            ...
            <div className='right_side'>
              ...
              <h5>Last Month - {studydata.timeframes?.monthly.previous}hrs</h5>
            </div>
        ...
        <div className='exercise'>
          ...
          <div className='info_box'>
            <div className='left_side'>
              <h3>{exercisedata.title}</h3>
              <h1>{exercisedata.timeframes?.monthly.current}hrs</h1>
            </div>
            ...
            <div className='right_side'>
              ...
              <h5>Last Month - {exercisedata.timeframes?.monthly.previous}hrs</h5>
            </div>
        ...
        <div className='social'>
          ...
          <div className='info_box'>
            <div className='left_side'>
              <h3>{socialdata.title}</h3>
              <h1>{socialdata.timeframes?.monthly.current}hrs</h1>
            </div>
              <div className='right_side'>
              <svg className='ellipses' width='21' height='5'>
                <path d="M2.5 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z" fill="#BBC0FF" fillRule="evenodd"/>
              </svg>
              <h5>Last Month - {socialdata.timeframes?.monthly.previous}hrs</h5>
            </div>
        ...
        <div className='self_care'>
          ...
          <div className='info_box'>
            <div className='left_side'>
              <h3>{selfcaredata.title}</h3>
              <h1>{selfcaredata.timeframes?.monthly.current}hrs</h1>
            </div>
            <div className='right_side'>
              <svg width='21' height='5' className='ellipses'>
                <path d="M2.5 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z" fill="#BBC0FF" fillRule="evenodd"/>
              ...
              <h5>Last Month - {selfcaredata.timeframes?.monthly.previous}hrs</h5>
            </div>
